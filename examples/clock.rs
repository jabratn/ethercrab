//! Use SwitchBoard in free run mode as DC-reference-clock.
//!
...
const MAX_PDU_DATA: usize = PduStorage::element_size(2048);
...
fn main() -> Result<(), Error> {
    ...
    smol::block_on(async {
        ...
        for mut slave in group.iter(&client) {
            // Disable SYNC0 for our SwitchBoard
            slave.set_dc_sync(DcSync::Disabled);
        }
